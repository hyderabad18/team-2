...
public class StudentNotificationAdapter extends RecyclerView.Adapter<StudentNotificationAdapter.MyViewHolder>
{
    ...
    StudentNotificationAdapter(List<ApprovedDefault> def, Context mContext)
    {
        this.def=def;
    ...
    @Override
    public StudentNotificationAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_notifications, parent, false);
        StudentNotificationAdapter.MyViewHolder myViewHolder = new StudentNotificationAdapter.MyViewHolder(view);
        return myViewHolder;
    }

    @Override
    public void onBindViewHolder(StudentNotificationAdapter.MyViewHolder holder, int position)
    {
